...
JSON_PATH = '/Users/gggcapital/Desktop/VIDLAB PROJECT/final_data/script/vidlab-marketing-460409-f0e918ae72e2.json'
SPREADSHEET_NAME = 'VidLab_Marketing_Tracking_Managed_v1'
STAFF_LIST_SHEET = 'Staff List'
LOGO_PATH = '/Users/gggcapital/Desktop/VIDLAB PROJECT/final_data/script/vidlab_logo.png'
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_msg = (
        ...
        "I'm Calvin from AI Content Department, and also is your Vidlab AI Assistant.\n\n"
        "Selamat datang ke Vidlab Marketing!\n"
        "Saya Calvin dari Jabatan Kandungan AI, juga merupakan Pembantu AI Vidlab anda.\n\n"
...
def sync_sheet_update(staff_id, telegram_user):
    try:
        ...
        # 调试输出
        print('All Staff:', all_staff)
        print('User Input:', staff_id)
...
def main():
    application = Application.builder().token('7816348098:AAFudlVLuFJ4VmExkLeWcADZMGYihTnChSM').build()
